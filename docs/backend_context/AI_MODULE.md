...
**Example Response:**
> "I've successfully booked your consultation appointment with Dr. Priya Sharma for March 15, 2026 at 10:30 AM. You'll receive a confirmation notification shortly."
...
- "Get my last 5 reports"

**Parameters:**
- `limit`: Number of reports (1-10, default: 5)
...
**Parameters:**
- `report_identifier`: Report ID, date, or description
...
> 1. Dr. Priya Sharma (Endocrinologist) - Active since Jan 2026
> 2. Dr. Rahul Kumar (General Physician) - Active since Dec 2025"
...
**Example Response:**
> "You have 15 active patients. Here are your most recent:
> 1. John Doe - Last appointment: March 10, 2026
> 2. Jane Smith - Last appointment: March 8, 2026
> 3. Ram Kumar - Last appointment: March 5, 2026"
...
The AI gracefully handles tool errors:

**Example Errors:**
- **Doctor not found**: "I couldn't find a doctor named 'Dr. XYZ' in your assigned doctors."
- **No appointments**: "You don't have any upcoming appointments scheduled."
- **Booking conflict**: "That time slot is already booked. Available times are: 11 AM, 2 PM, 4 PM."
- **Permission denied**: "You don't have permission to view this patient's data."

### **Best Practices**

1. **Natural Language**: Users can ask in natural conversational style
2. **Flexible Inputs**: Multiple ways to phrase the same request
